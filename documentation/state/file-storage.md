...
## Cross-references
- [Common module](/charter/modules/cross-cutting/common-module.md) — owns the storage package.
- [Attachment module](/charter/modules/content/attachment-module.md) — the consumer of storage.