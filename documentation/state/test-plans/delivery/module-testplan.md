...
Domain-specific scenarios to add to `postman/nemo-api-collection.json` (see [Postman collection](/state/postman-collection.md)):
...
- [Delivery module entities](/charter/modules/delivery/module-entities.md) — entities under test.
