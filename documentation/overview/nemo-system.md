...
- [Monorepo structure](/overview/monorepo-structure.md) — how the code is laid out.
- [Backend layering](/overview/backend-layering.md) — the internal pattern of every module.
- [Tech stack](/overview/tech-stack.md) — concrete technologies and versions.
- [Security: multi-tenancy](/security/multi-tenancy.md) — the company-scoping model.