...
- [Monorepo structure](/overview/monorepo-structure.md) — where these packages live.
- [Request data flow](/overview/request-data-flow.md) — how a request traverses the layers.
- [Common module](/modules/cross-cutting/common-module.md) — shared DTOs and the global exception handler.