...
- [Frontend architecture](/implementation/architecture/frontend-architecture.md) — how these are arranged.
- [Monorepo structure](/overview/monorepo-structure.md) — repo layout.