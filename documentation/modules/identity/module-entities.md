...
- [Company module](/modules/identity/company-module.md), [User module](/modules/identity/user-module.md) — the owning modules.
- [Multi-tenancy](/security/multi-tenancy.md) — the `company_id` scoping convention.
- [Cross-cutting module entities](/modules/cross-cutting/module-entities.md) — `OrganizationConfig` is scoped per company.