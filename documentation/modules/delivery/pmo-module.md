...
| Component | Purpose |
|-----------|---------|
| `RaidItem` | risks, assumptions, issues, dependencies (see [delivery module entities](/modules/delivery/module-entities.md) for fields) |
...
`UserRate` (in the [time tracking module](/modules/timetracking/index.md)) converts logged hours into actual cost; rates vary by `effectiveFrom` date.

## Cross-references

- [Project module](/modules/delivery/project-module.md) — RAID items attach to projects; EVM reads project budget fields.
- [Delivery module entities](/modules/delivery/module-entities.md) — `RaidItem` entity.
- [UML diagrams](/implementation/architecture/uml-diagrams.md) — domain class diagram including `RaidItem`/`UserRate`.
- [Delivery module test plan](/modules/delivery/module-testplan.md) — PMO/RAID endpoint and EVM service tests.