...
- [Leave module](/modules/hr/leave-module.md), [Evaluation module](/modules/hr/evaluation-module.md) — the owning modules.
- [Identity module entities](/modules/identity/module-entities.md) — `User` owns leave/entitlements.