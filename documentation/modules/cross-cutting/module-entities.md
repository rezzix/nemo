...
- [Config module](/modules/cross-cutting/config-module.md), [Common module](/modules/cross-cutting/common-module.md) — the owning modules.
- [Audit logging](/implementation/cross-cutting/audit-logging.md), [Activity tracking](/implementation/cross-cutting/activity-tracking.md) — the mechanisms.
- [Delivery module entities](/modules/delivery/module-entities.md) — `Task` consumes `TaskType`/`TaskStatus`.