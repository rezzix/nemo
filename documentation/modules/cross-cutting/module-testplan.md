...
- [Cross-cutting module entities](/modules/cross-cutting/module-entities.md) — entities under test.
...
- [Authentication](/security/authentication.md), [Authorization (RBAC)](/security/authorization-rbac.md) — the security behavior these tests assert.