...
- [Documentation module](/modules/content/documentation-module.md), [Attachment module](/modules/content/attachment-module.md), [Asset module](/modules/content/asset-module.md), [Location module](/modules/content/location-module.md) — the owning modules.
- [File storage](/implementation/cross-cutting/file-storage.md) — the pluggable storage abstraction behind `Attachment`.
- [Delivery module entities](/modules/delivery/module-entities.md) — `Task` is an attachable target.