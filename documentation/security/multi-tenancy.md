...
## Cross-references
- [Authorization (RBAC)](/security/authorization-rbac.md) — where scoping is enforced.
- [Company module](/modules/identity/company-module.md) — the tenant entity.
- [Identity module entities](/modules/identity/module-entities.md) — which entities carry `company_id`.