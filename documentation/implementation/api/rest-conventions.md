...
## Cross-references
- [Backend layering](/overview/backend-layering.md) — controllers return DTOs only.
- [Frontend architecture](/implementation/architecture/frontend-architecture.md) — API client layer that calls these paths.