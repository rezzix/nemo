...
## Cross-references
- [Request data flow](/overview/request-data-flow.md) — where errors surface in the lifecycle.
- [Common module](/modules/cross-cutting/common-module.md) — owns the exception package.