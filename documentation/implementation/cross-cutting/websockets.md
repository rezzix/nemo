...
## Cross-references
- [Config module](/modules/cross-cutting/config-module.md) — owns `WebSocketConfig`.
- [Task module](/modules/delivery/task-module.md) — moves trigger updates.
- [Project module](/modules/delivery/project-module.md) — the board.