...
- [Identity module entities](/charter/modules/identity/module-entities.md) — `Company`, `User`.
- [Cross-cutting module entities](/charter/modules/cross-cutting/module-entities.md) — `OrganizationConfig`, `TaskType`, `TaskStatus`, `PublicHoliday`, `AuditLog`, `ActivityLog`.
- [Delivery module entities](/charter/modules/delivery/module-entities.md) — program/project/task/sprint/phase/PMO.
- [Commercial module entities](/charter/modules/commercial/module-entities.md) — client, expense, payment.
- [Finance module entities](/charter/modules/finance/module-entities.md) — banks and reconciliation.
- [HR module entities](/charter/modules/hr/module-entities.md) — leave and (planned) evaluation.
- [Time tracking module entities](/charter/modules/timetracking/module-entities.md) — time log, user rate, timesheet.
- [Content module entities](/charter/modules/content/module-entities.md) — wiki, attachment, asset, location.

## Cross-references

- [Multi-tenancy](/charter/security/multi-tenancy.md) — the `company_id` scoping convention.
- [Backend layering](/charter/overview/backend-layering.md) — the Entity/Repository tier that owns this schema.