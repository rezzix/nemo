...
Field-level detail per group: [identity](/charter/modules/identity/module-entities.md), [cross-cutting](/charter/modules/cross-cutting/module-entities.md), [delivery](/charter/modules/delivery/module-entities.md), [commercial](/charter/modules/commercial/module-entities.md), [finance](/charter/modules/finance/module-entities.md), [hr](/charter/modules/hr/module-entities.md), [timetracking](/charter/modules/timetracking/module-entities.md), [content](/charter/modules/content/module-entities.md).
...
Role meanings and the full access matrix: [authorization (RBAC)](/charter/security/authorization-rbac.md), [features and access](/charter/security/features-and-access.md).
...
See the [task module](/charter/modules/delivery/task-module.md).
...
See [authentication](/charter/security/authentication.md).
...
See the [modules index](/charter/modules/index.md) and [monorepo structure](/charter/overview/monorepo-structure.md).
...
See the [time tracking module](/charter/modules/timetracking/index.md).
...
See [features and access](/charter/security/features-and-access.md) for the detailed matrix.
