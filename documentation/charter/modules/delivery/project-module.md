...
- [Task module](/charter/modules/delivery/task-module.md) — tasks belong to a project.
- [Sprint module](/charter/modules/delivery/sprint-module.md), [Phase module](/charter/modules/delivery/phase-module.md) — planning sub-units.
- [PMO module](/charter/modules/delivery/pmo-module.md) — RAID items per project.
- [Delivery module entities](/charter/modules/delivery/module-entities.md) — `Project` and sub-entities.