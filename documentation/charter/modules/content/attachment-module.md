...
`attachment/` manages file attachments; actual bytes go through the [pluggable storage service](/state/file-storage.md) (`FilesystemStorageService` by default, S3-swappable).
