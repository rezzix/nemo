                  ...
                  {evm && (
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-4 text-xs">
                        <span>
                          CPI: <span className={evm.cpi != null ? (evm.cpi >= 1 ? 'text-green-600' : evm.cpi >= 0.9 ? 'text-yellow-600' : 'text-red-600') : ''}>{evm.cpi != null ? evm.cpi.toFixed(2) : '—'}</span>
                        </span>
                        <span>
                          SPI: <span className={evm.spi != null ? (evm.spi >= 1 ? 'text-green-600' : evm.spi >= 0.9 ? 'text-yellow-600' : 'text-red-600') : ''}>{evm.spi != null ? evm.spi.toFixed(2) : '—'}</span>
                        </span>
                      </div>
                    </div>
                  )}
