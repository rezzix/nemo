  ...
  const sections: NavSection[] = [
    {
      items: [
        ...
        ...(!isExternal && (role === 'ADMIN' || role === 'MANAGER' || role === 'EXECUTIVE' || role === 'HR' || role === 'FINANCE')
    ...
    ...(!isExternal ? [{
      ...
      items: [
        ...
        ...(role === 'FINANCE'
          ...
          : []),
        ...(role === 'FINANCE' || role === 'ADMIN' || role === 'EXECUTIVE'
          ? [{ to: '/finance/dashboard', label: 'Bank Dashboard', icon: BankDashboardIcon }]
          : []),
...
function BankDashboardIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
